...
import { register as registerApi, getGoogleAuthUrl } from '../services/api';
import { GraduationCap, ArrowRight, Mail, Lock, User, Eye, EyeOff } from 'lucide-react';
    ...
    <div style={{ minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      >
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <h1 style={{ fontSize: '1.5rem', fontWeight: 600, color: '#2c241e' }}>Create Account</h1>
          <p style={{ fontSize: '0.875rem', color: 'rgba(44, 36, 30, 0.5)', marginTop: '0.25rem' }}>
            Start tracking your classroom activities
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          <div>
            ...
            <div style={{ position: 'relative' }}>
              <User style={{ position: 'absolute', left: '12px', top: '50%', transform: 'translateY(-50%)', width: '16px', height: '16px', color: 'rgba(44, 36, 30, 0.3)' }} />
              <input
                type="text"
                value={name}
        ...
        <p style={{ textAlign: 'center', marginTop: '1.5rem', fontSize: '0.8rem', color: 'rgba(44, 36, 30, 0.5)' }}>
          ...
          <Link to="/login" style={{ color: '#c4845a', textDecoration: 'none', fontWeight: 500 }}>
            Sign in
          </Link>
        </p>
      </motion.div>
